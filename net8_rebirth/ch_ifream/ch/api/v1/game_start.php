...
try {
    ...
    // DocumentRoot が /var/www/html/ch なので /data/ プレフィックス必要（オリジナルと同じ構造）
    ...
    $playEmbedUrl = "/data/play_embed/?sessionId={$sessionId}&NO={$machine['machine_no']}&lang={$lang}&currency={$currency}{$cameraIdParam}";
