...
// 管理画面セッション設定
define('SESSION_SEC_ADMIN', 3600); // 管理画面セッション継続時間（秒） = 1時間
define('SESSION_SID_ADMIN', 'NET8ADMIN'); // 管理画面セッションID名
...
define('DIR_HTML_ADMIN', __DIR__ . '/../_html/ja/admin/'); // 管理画面HTMLテンプレート（言語フォルダ含む）

// 管理画面リスト表示設定
define('ADMIN_LIST_ROWMAX', 50); // 管理画面リスト1ページあたりの表示件数
...
define('DEFAULT_END_DATE', '2099-12-31'); // デフォルト終了日
define('PLAY_PAST_MAX', true); // 過去最大数クリア機能
...
define('GIFTHISTORY_DOWNLOAD', true);        // ギフト履歴ダウンロード機能

// ページネーション設定
define('PAGE_SPAN', 5);                      // ページネーション表示範囲

// プレイ履歴設定
define('PLAYHISTORY_PERIOD', 31);            // プレイ履歴検索期間（日数）
